...
Provides 2 functions:
    clip(height): An actual clip, height is the height to print with the click laid flat
    socket(height): The cutout to generate for the clip. It's suggented to make the height slightly more to ease access
*/
CLIP_STOPPER = 2;
CLIP_SOCKET_W = 7*2;
CLIP_SOCKET_D = 10.6;
